...
function editRecord(id){
    var f=document.form;
    f.method="post";
    f.action='updateReview.jsp?id='+id;
    f.submit();
}
function deleteRecord(id){
    var f=document.form;
    f.method="post";
    f.action='delReviewServlet?id='+id;
    f.submit();
}
</script>
</head>
...
<table border="1">
<h2>All Reviews</h2>
<tr><th>Review Id</th><th>User Name</th><th>Email</th><th>Review</th><th>acknowledgement</th></tr>
...
<td><input type="button" name="edit" value="Edit" style="background-color:#49743D;font-weight:bold;color:#ffffff;" onclick="editRecord(<%=rs.getString(1)%>);" >
